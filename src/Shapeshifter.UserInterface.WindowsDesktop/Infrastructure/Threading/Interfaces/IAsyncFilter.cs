...
namespace Shapeshifter.UserInterface.WindowsDesktop.Infrastructure.Threading.Interfaces
{
    ...
    {
        Task<IEnumerable<TResult>> FilterAsync<TResult>(IEnumerable<Task<TResult>> candidates,
            Func<TResult, Task<bool>> filter);

        Task<IEnumerable<TResult>> FilterAsync<TResult>(IEnumerable<TResult> candidates,
            Func<TResult, Task<bool>> filter);
