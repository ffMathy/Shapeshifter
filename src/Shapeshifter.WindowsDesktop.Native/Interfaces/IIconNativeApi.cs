namespace Shapeshifter.WindowsDesktop.Native.Interfaces
{
    ...
    public interface IIconNativeApi
    {
        ...
        void SHCreateItemFromParsingName([In][MarshalAs(UnmanagedType.LPWStr)] string pszPath, [In] IntPtr pbc, [In][MarshalAs(UnmanagedType.LPStruct)] Guid riid, [MarshalAs(UnmanagedType.Interface, IidParameterIndex = 2)][Out] out IconNativeApi.IShellItem ppv);
